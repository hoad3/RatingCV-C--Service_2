...
namespace RatingCV.Migrations
{
    ...
    [Migration("20250424093931_InitialCreate-16")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RatingCV.Model.cv_ungvien.rating_cv", b =>
                {
                    ...
                    b.Property<int>("ungvien_id")
                        .HasColumnType("integer");

                    b.HasKey("id");

                    b.HasIndex("ungvien_id")
                        .IsUnique();
            ...
            modelBuilder.Entity("RatingCV.Model.github.github_link", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RatingCV.Model.cv_ungvien.rating_cv", b =>
                {
                    b.HasOne("RatingCV.Model.cv_ungvien.cv_ungvien", null)
                        .WithOne()
                        .HasForeignKey("RatingCV.Model.cv_ungvien.rating_cv", "ungvien_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("RatingCV.Model.github.github_link", b =>
                {
                    b.HasOne("RatingCV.Model.cv_ungvien.cv_ungvien", "cv_ungvien")
                        .WithMany("github_links")
                        .HasForeignKey("userid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("cv_ungvien");
                });

            modelBuilder.Entity("RatingCV.Model.cv_ungvien.cv_ungvien", b =>
                {
                    b.Navigation("github_links");
                });
